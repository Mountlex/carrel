    ...
    <>
      <div className="border-b p-4 dark:border-gray-700">
        <input
          ...
          className="w-full rounded-md border border-gray-300 px-3 py-2 text-sm focus:border-primary-500 focus:outline-none focus:ring-1 focus:ring-primary-500 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-100 dark:placeholder-gray-400"
        />
      </div>
      <div className="flex-1 overflow-y-auto p-2">
        ...
        {error && <p className="px-2 pb-2 text-sm text-danger-600 dark:text-danger-400">{error}</p>}
      </div>
