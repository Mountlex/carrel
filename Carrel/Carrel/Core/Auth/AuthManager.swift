...
final class AuthManager {
    ...
    static let baseURL = URL(string: "https://kindhearted-bloodhound-95.convex.site")!
    ...
    func signInWithEmail(email: String, password: String) async throws {
        ...
        let tokens = try await client.signInWithEmail(email: email, password: password)
        await handleOAuthCallback(tokens: tokens)
    }
    ...
    func signUpWithEmail(email: String, password: String) async throws {
        ...
        let client = ConvexClient(baseURL: Self.baseURL, authManager: self)
        let tokens = try await client.signUpWithEmail(email: email, password: password)
        await handleOAuthCallback(tokens: tokens)
    }
